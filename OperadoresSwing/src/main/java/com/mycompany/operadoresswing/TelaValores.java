...
public class TelaValores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDvidir = new javax.swing.JButton();
        ...
        jLabel1.setText("Numrador");

        jLabel2.setText("Denominador");

        btnDvidir.setText("Calcular");
        btnDvidir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDvidirActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNum)
                            .addComponent(txtDen, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
    ...
    private void btnDvidirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDvidirActionPerformed
        
        int n = Integer.parseInt(txtNum.getText());
        int d = Integer.parseInt(txtDen.getText());
        float div  = n/d;
        float res = (float) Math.sqrt(n);
        lblDiv.setText(Float.toString(div)); //setText é um método utilizado para definir o texto de um componente
        lblRes.setText(Float.toString(res));
    }//GEN-LAST:event_btnDvidirActionPerformed
    ...
    private javax.swing.JButton btnDvidir;
